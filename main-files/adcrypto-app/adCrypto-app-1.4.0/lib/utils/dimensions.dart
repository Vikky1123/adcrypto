...
class Dimensions {
  ...
  static double paddingSizeMedium = 16.00.r;
  static double paddingSizeSmall = 8.00.r;
  ...
  // typography size
  static double headingTextSize0 = 40.00.sp;
  ...
  static double onboardBtnIconWidthSize = 7.17.w;
  static double onboardBtnIconHeightSize = 11.42.h;
}