import 'package:adcrypto/controller/dashboard/withdraw_crypto/withdraw_crypto_controller.dart';
...
class InputWithDropdownForWithdraw extends StatefulWidget {
  ...
  const InputWithDropdownForWithdraw({
    super.key,
  ...
  @override
  State<InputWithDropdownForWithdraw> createState() => _InputWithDropdownForWithdrawState();
}

class _InputWithDropdownForWithdrawState extends State<InputWithDropdownForWithdraw> {
  FocusNode? focusNode;
  final currencyController = Get.find<WithdrawCryptoController>();
              ...
              children: [
                ...
                Container(
                    ...
                    child: DropdownButton2<Currency>(
                      ...
                      underline: Container(),
                      items: currencyController.withdrawCryptoModel.data.currencies
