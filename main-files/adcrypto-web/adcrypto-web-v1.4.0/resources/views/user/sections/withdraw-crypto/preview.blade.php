...
@section('breadcrumb')
    ...
    ], 'active' => __("Withdraw Crypto Preview")])
@endsection
    ...
    <div class="row justify-content-center mt-30">
        <div class="col-xxl-6 col-xl-8 col-lg-8">
            <div class="custom-card">
                ...
                <form action="{{ setRoute('user.withdraw.crypto.confirm',$data->identifier) }}" method="post">
                    @csrf
                    <div class="card-body">
                        <div class="preview-list-wrapper">
                            <div class="preview-list-item">
                                ...
                                <div class="preview-list-right">
                                    <span>{{ $data->data->receiver_wallet->address ?? '' }}</span>
                                </div>
                            </div>
                            <div class="preview-list-item">
                                <div class="preview-list-left">
                                ...
                                <div class="preview-list-right">
                                    <span class="text--success">{{ $data->data->amount ?? '' }} {{ $data->data->sender_wallet->code ?? '' }}</span>
                                </div>
                            </div>
                            <div class="preview-list-item">
                                <div class="preview-list-left">
                                ...
                                <div class="preview-list-right">
                                    <span class="text--warning">{{ $data->data->sender_ex_rate ?? '' }} {{ $data->data->sender_wallet->code ?? '' }} = {{ $data->data->exchange_rate ?? '' }} {{ $data->data->receiver_wallet->code ?? '' }}</span>
                                </div>
                            </div>
                            <div class="preview-list-item">
                                <div class="preview-list-left">
