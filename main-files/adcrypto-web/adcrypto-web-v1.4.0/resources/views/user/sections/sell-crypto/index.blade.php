...
<script>
    ...
    function calculation(paymentMinAmount,paymentMaxAmount,paymentFixedCharge,paymentPercentCharge,paymentMethodRate,paymentMethodCode,currencyRate,currencyCode){
        ...
        var min_max_rate        = parseFloat(currencyRate) / parseFloat(paymentMethodRate);
        var fixedCharge         = parseFloat(paymentFixedCharge) * min_max_rate;
        var amount              = $('.amount').val();
        var percentCharge      = (amount / 100) * paymentPercentCharge;
        ...
        $('.charge').text(networkFeesText + ': ' + totalCharge.toFixed(10) + " " + currencyCode);
