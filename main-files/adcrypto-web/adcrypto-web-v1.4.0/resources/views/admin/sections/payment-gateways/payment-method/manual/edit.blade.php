...
@section('breadcrumb')
    ...
    ], 'active' => __("Manual Payment Method Edit")])
@endsection

@section('content')
    <form action="{{ setRoute('admin.payment.gateway.update',['payment-method','manual',$payment_gateway->alias]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method("PUT")
