...
@section('content')
    ...
    @include('admin.components.modals.site-section.service-section.add')

    @include('admin.components.modals.site-section.service-section.edit')
@endsection
@push('script')
    ...
    <script>
        ...
        $(document).ready(function(){
            // Switcher
            switcherAjax("{{ setRoute('admin.setup.sections.service.status.update',$slug) }}");
        })
    </script>
