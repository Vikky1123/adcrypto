    ...
    */
    ...
    public function statusUpdate(Request $request,$trx_id){
        ...
        try{
            ...
            if($validated['status'] == global_const()::STATUS_CONFIRM_PAYMENT && $transaction->currency->gateway->isManual() && $transaction->details->data->wallet->type == GlobalConst::INSIDE_WALLET){
